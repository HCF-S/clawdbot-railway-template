...
RUN npm install -g mcporter@0.7.3 @heyamiko/amiko-cli @heyamiko/openclaw-amiko @tencent-weixin/openclaw-weixin \
  && ln -s "$(npm root -g)/@heyamiko/openclaw-amiko" /openclaw/extensions/openclaw-amiko \
  && ln -s "$(npm root -g)/@tencent-weixin/openclaw-weixin" /openclaw/extensions/openclaw-weixin
