...
`;
    ...
    // CLI skill docs are now managed by syncAmikoCLISkill() in server.js
    // which copies SKILL.md from the installed CLI package to /data/.openclaw/skills/amiko-cli/
    // No more hardcoded TOOLS.md injection needed.
